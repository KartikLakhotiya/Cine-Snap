...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5 rounded-full">
              ...
              <>
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 -mx-2 -my-1 bg-pink-400/80 rounded-full -z-10"
